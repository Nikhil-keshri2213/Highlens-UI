...
const SelfHome = () => {
  return (
    <div className="w-full flex flex-col md:flex-row items-end justify-around gap-10 md:gap-20 p-8 md:p-16 relative">
      <div className="w-full md:w-[30%] mb-10">
        <CardContainer>
          <CardBody>
            <div className="bg-linear-to-br from-slate-500/30 via-black/20 to-gray-500/40 border border-white/20 rounded-3xl h-[520px] w-[550px] p-6 hover:shadow-[0_0_15px_rgba(255,255,255,1)] transition-all duration-300">
              ...
              <CardItem translateZ={70}>
                <div className="text-base p-2 mb-4 text-white">
              ...
              <CardItem translateZ={120}>
                <img
                  ...
                  alt="WhiteBG"
                  loading="lazy"
                  className="h-[120px] object-cover rounded-xl shadow-md border border-white/30"
                />
              </CardItem>
              ...
              <CardItem translateZ={80} className="mt-auto">
                <button className="w-[50%] py-4 bg-white text-black text-lg rounded-full mt-10 ml-70 font-bold cursor-pointer hover:shadow-[0_0_25px_rgba(255,255,255,1)] transition-all duration-300">
                  Explore Now
                </button>
              </CardItem>
            </div>
        ...
        <div className="relative p-8 rounded-2xl bg-black/30 backdrop-blur-sm border border-white/30 border-dashed h-[450px] flex flex-col justify-between overflow-hidden">
          ...
          <div className="relative z-10 space-y-6">
            <div className="space-y-6">
              <h3 className="text-2xl md:text-3xl font-bold font-stretch-50% leading-tight text-white uppercase">
            ...
            <div className="text-center">
              <p className="text-xl md:text-[50px] font-bold uppercase mt-16 text-white">
                All in one place.
              </p>
            </div>
          </div>
