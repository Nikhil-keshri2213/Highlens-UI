...
const HeaderBanner = () => {
  ...
  return (
    <div className="w-full h-screen relative overflow-hidden flex flex-col items-center">
      {/* Top Header */}
      <div
        className="h-[55px] w-[750px] border border-white/30 rounded-full bg-white/10 backdrop-blur-md 
      ...
      >
        <div className="font-bold text-lg text-white flex items-center gap-2">
          <RiCameraLensFill className="text-white text-[30px] transition-transform duration-500 hover:rotate-90" />
          HIGHLENS
        </div>
      ...
      <div className="flex flex-col items-center justify-center text-center gap-6 grow">
        ...
        <div className="flex flex-row gap-4 mt-4">
          {/* Glow on hover (+ scale) */}
          <button
            className="text-[20px] w-[180px] h-[45px] bg-white rounded-full font-semibold 
